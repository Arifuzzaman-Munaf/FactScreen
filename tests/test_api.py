#!/usr/bin/env python3
"""
Legacy test script for FactScreen API endpoints
This file is kept for backward compatibility.
For new tests, use test_integration.py and test_services.py
"""
...
def main():
    """Run all tests"""
    print("=" * 50)
    print("FactScreen API Test Suite (Legacy)")
    print("=" * 50)
    print("Note: For comprehensive testing, use:")
    print("  - test_integration.py for API endpoint tests")
    print("  - test_services.py for unit tests")
    print("=" * 50)
