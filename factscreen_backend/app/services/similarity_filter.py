...
class SimilarityFilterService:
    ...
    def filter_claims_by_similarity(self, claims: List[Dict[str, Any]], query: str, similarity_threshold: float = None) -> List[Dict[str, Any]]:
        """
    ...
    def filter_claims_dataframe(self, df: pd.DataFrame, query: str, similarity_threshold: float = None) -> pd.DataFrame:
        """
        ...
        filtered_df = df_with_scores[df_with_scores['query_similarity_score'] >= similarity_threshold]
