...
class ClaimClassificationService:
    ...
    def _setup_keywords(self):
        ...
        self.true_keywords = [
            "true", "correct", "accurate", "valid", "factual", 
            "verified", "confirmed", "legitimate", "proven"
        ]
        self.false_misleading_keywords = [
            "false", "misleading", "lie", "incorrect", "debunked", 
            "refuted", "inaccurate", "fabricated", "untrue", "wrong",
            "fake", "hoax", "myth", "busted", "disproven"
        ]
        self.no_info_keywords = [
            "not enough", "no evidence", "unproven", "no proof", 
            "inconclusive", "unclear", "insufficient", "unknown",
            "partly true", "partially true", "mixed", "unverified"
        ]
