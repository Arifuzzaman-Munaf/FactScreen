...
class TestFilteredClaims:
    ...
    def test_filtered_claims_classification(self):
        ...
        payload = {
            "query": "PM Narendra Modi has announced a Diwali cash gift worth ₹10,000 for all citizens",
            "language_code": "en",
            "page_size": 5,
        ...
        for claim in data["claims"]:
            ...
            assert claim["normalized_rating"] in ["True", "False or Misleading", "Not enough information found"]
