...
def render_home_page() -> None:
    ...
    with col_result:
        ...
        verdict_display.markdown(
            st.session_state["verdict_card_html"], unsafe_allow_html=True
        )
    ...
    evidence_placeholder.markdown(
        st.session_state["evidence_table_html"], unsafe_allow_html=True
    )
        ...
        if not claim_text.strip() and not claim_url.strip():
            ...
            try:
                ...
                confidence_html = dedent(
                    ...
                    """
                ).strip() if confidence_pct is not None else dedent(
                    """
                    <div class="confidence-gauge" data-empty="true">
                        <div class="confidence-center">
                            <span>—</span>
